...
describe('rabbit, rpc', () => {
  [
    ...
    test('rabbit rpc', (done) => {
      ...
      io.rabbit
        .onRpc(queueName, (message, reply, err) => {
...
test('rpc with replyTo', (done) => {
  ...
  io.rabbit
    .publishRpc(rpcName, 'test', { replyTo: queueName })
    .then((msg) => {
